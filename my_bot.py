...
bot = telebot.TeleBot(token='7540348397:AAE3B96H5bp364DvAWKM54yEAl585GbPtXI')
...
def get_text_message(message):
    if message.text == '/Hello':
        bot.send_message(
            ...
            'Привет, сейчас я расскажу тебе гороскоп на сегодня. Напиши /Start.'
        ...
        bot.send_message(message.from_user.id, "Я тебя не понимаю. Напиши /Hello.")
